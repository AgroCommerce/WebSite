/*
  ...
  - You are about to alter the column `telefone` on the `produtores` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
